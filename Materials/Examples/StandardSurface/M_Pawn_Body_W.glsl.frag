...
void main()
{
    ...
    mx_image_color3(diffuse8_file, diffuse8_layer, diffuse8_default, geomprop_UV0_out, diffuse8_uaddressmode, diffuse8_vaddressmode, diffuse8_filtertype, diffuse8_framerange, diffuse8_frameoffset, diffuse8_frameendaction, diffuse8_uv_scale, diffuse8_uv_offset, diffuse8_out);
    float metallic8_out = 0.0;
    mx_image_float(metallic8_file, metallic8_layer, metallic8_default, geomprop_UV0_out, metallic8_uaddressmode, metallic8_vaddressmode, metallic8_filtertype, metallic8_framerange, metallic8_frameoffset, metallic8_frameendaction, metallic8_uv_scale, metallic8_uv_offset, metallic8_out);
    float roughness8_out = 0.0;
    mx_image_float(roughness8_file, roughness8_layer, roughness8_default, geomprop_UV0_out, roughness8_uaddressmode, roughness8_vaddressmode, roughness8_filtertype, roughness8_framerange, roughness8_frameoffset, roughness8_frameendaction, roughness8_uv_scale, roughness8_uv_offset, roughness8_out);
    vec3 normal8_out = vec3(0.0);
    mx_image_vector3(normal8_file, normal8_layer, normal8_default, geomprop_UV0_out, normal8_uaddressmode, normal8_vaddressmode, normal8_filtertype, normal8_framerange, normal8_frameoffset, normal8_frameendaction, normal8_uv_scale, normal8_uv_offset, normal8_out);
    vec3 diffuse8_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse8_out, diffuse8_out_cm_out);
    vec3 mtlxnormalmap10_out = vec3(0.0);
    mx_normalmap(normal8_out, mtlxnormalmap10_space, mtlxnormalmap10_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap10_out);
    surfaceshader Pawn_Body_W_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Pawn_Body_W_base, diffuse8_out_cm_out, Pawn_Body_W_diffuse_roughness, metallic8_out, Pawn_Body_W_specular, Pawn_Body_W_specular_color, roughness8_out, Pawn_Body_W_specular_IOR, Pawn_Body_W_specular_anisotropy, Pawn_Body_W_specular_rotation, Pawn_Body_W_transmission, Pawn_Body_W_transmission_color, Pawn_Body_W_transmission_depth, Pawn_Body_W_transmission_scatter, Pawn_Body_W_transmission_scatter_anisotropy, Pawn_Body_W_transmission_dispersion, Pawn_Body_W_transmission_extra_roughness, Pawn_Body_W_subsurface, diffuse8_out_cm_out, diffuse8_out_cm_out, Pawn_Body_W_subsurface_scale, Pawn_Body_W_subsurface_anisotropy, Pawn_Body_W_sheen, Pawn_Body_W_sheen_color, Pawn_Body_W_sheen_roughness, Pawn_Body_W_coat, Pawn_Body_W_coat_color, Pawn_Body_W_coat_roughness, Pawn_Body_W_coat_anisotropy, Pawn_Body_W_coat_rotation, Pawn_Body_W_coat_IOR, geomprop_Nworld_out, Pawn_Body_W_coat_affect_color, Pawn_Body_W_coat_affect_roughness, Pawn_Body_W_thin_film_thickness, Pawn_Body_W_thin_film_IOR, Pawn_Body_W_emission, Pawn_Body_W_emission_color, Pawn_Body_W_opacity, Pawn_Body_W_thin_walled, mtlxnormalmap10_out, geomprop_Tworld_out, Pawn_Body_W_out);

...
void main()
{
    ...
    mx_image_color3(diffuse7_file, diffuse7_layer, diffuse7_default, geomprop_UV0_out, diffuse7_uaddressmode, diffuse7_vaddressmode, diffuse7_filtertype, diffuse7_framerange, diffuse7_frameoffset, diffuse7_frameendaction, diffuse7_uv_scale, diffuse7_uv_offset, diffuse7_out);
    float metallic7_out = 0.0;
    mx_image_float(metallic7_file, metallic7_layer, metallic7_default, geomprop_UV0_out, metallic7_uaddressmode, metallic7_vaddressmode, metallic7_filtertype, metallic7_framerange, metallic7_frameoffset, metallic7_frameendaction, metallic7_uv_scale, metallic7_uv_offset, metallic7_out);
    float roughness7_out = 0.0;
    mx_image_float(roughness7_file, roughness7_layer, roughness7_default, geomprop_UV0_out, roughness7_uaddressmode, roughness7_vaddressmode, roughness7_filtertype, roughness7_framerange, roughness7_frameoffset, roughness7_frameendaction, roughness7_uv_scale, roughness7_uv_offset, roughness7_out);
    vec3 normal7_out = vec3(0.0);
    mx_image_vector3(normal7_file, normal7_layer, normal7_default, geomprop_UV0_out, normal7_uaddressmode, normal7_vaddressmode, normal7_filtertype, normal7_framerange, normal7_frameoffset, normal7_frameendaction, normal7_uv_scale, normal7_uv_offset, normal7_out);
    vec3 diffuse7_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse7_out, diffuse7_out_cm_out);
    vec3 mtlxnormalmap9_out = vec3(0.0);
    mx_normalmap(normal7_out, mtlxnormalmap9_space, mtlxnormalmap9_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap9_out);
    surfaceshader Castle_W_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Castle_W_base, diffuse7_out_cm_out, Castle_W_diffuse_roughness, metallic7_out, Castle_W_specular, Castle_W_specular_color, roughness7_out, Castle_W_specular_IOR, Castle_W_specular_anisotropy, Castle_W_specular_rotation, Castle_W_transmission, Castle_W_transmission_color, Castle_W_transmission_depth, Castle_W_transmission_scatter, Castle_W_transmission_scatter_anisotropy, Castle_W_transmission_dispersion, Castle_W_transmission_extra_roughness, Castle_W_subsurface, diffuse7_out_cm_out, diffuse7_out_cm_out, Castle_W_subsurface_scale, Castle_W_subsurface_anisotropy, Castle_W_sheen, Castle_W_sheen_color, Castle_W_sheen_roughness, Castle_W_coat, Castle_W_coat_color, Castle_W_coat_roughness, Castle_W_coat_anisotropy, Castle_W_coat_rotation, Castle_W_coat_IOR, geomprop_Nworld_out, Castle_W_coat_affect_color, Castle_W_coat_affect_roughness, Castle_W_thin_film_thickness, Castle_W_thin_film_IOR, Castle_W_emission, Castle_W_emission_color, Castle_W_opacity, Castle_W_thin_walled, mtlxnormalmap9_out, geomprop_Tworld_out, Castle_W_out);

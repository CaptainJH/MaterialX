...
void main()
{
    ...
    mx_image_color3(diffuse1_file, diffuse1_layer, diffuse1_default, geomprop_UV0_out, diffuse1_uaddressmode, diffuse1_vaddressmode, diffuse1_filtertype, diffuse1_framerange, diffuse1_frameoffset, diffuse1_frameendaction, diffuse1_uv_scale, diffuse1_uv_offset, diffuse1_out);
    float metallic1_out = 0.0;
    mx_image_float(metallic1_file, metallic1_layer, metallic1_default, geomprop_UV0_out, metallic1_uaddressmode, metallic1_vaddressmode, metallic1_filtertype, metallic1_framerange, metallic1_frameoffset, metallic1_frameendaction, metallic1_uv_scale, metallic1_uv_offset, metallic1_out);
    float roughness1_out = 0.0;
    mx_image_float(roughness1_file, roughness1_layer, roughness1_default, geomprop_UV0_out, roughness1_uaddressmode, roughness1_vaddressmode, roughness1_filtertype, roughness1_framerange, roughness1_frameoffset, roughness1_frameendaction, roughness1_uv_scale, roughness1_uv_offset, roughness1_out);
    float sss1_out = 0.0;
    mx_image_float(sss1_file, sss1_layer, sss1_default, geomprop_UV0_out, sss1_uaddressmode, sss1_vaddressmode, sss1_filtertype, sss1_framerange, sss1_frameoffset, sss1_frameendaction, sss1_uv_scale, sss1_uv_offset, sss1_out);
    vec3 normal1_out = vec3(0.0);
    mx_image_vector3(normal1_file, normal1_layer, normal1_default, geomprop_UV0_out, normal1_uaddressmode, normal1_vaddressmode, normal1_filtertype, normal1_framerange, normal1_frameoffset, normal1_frameendaction, normal1_uv_scale, normal1_uv_offset, normal1_out);
    vec3 diffuse1_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse1_out, diffuse1_out_cm_out);
    vec3 mtlxnormalmap3_out = vec3(0.0);
    mx_normalmap(normal1_out, mtlxnormalmap3_space, mtlxnormalmap3_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap3_out);
    surfaceshader Queen_W_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Queen_W_base, diffuse1_out_cm_out, Queen_W_diffuse_roughness, metallic1_out, Queen_W_specular, Queen_W_specular_color, roughness1_out, Queen_W_specular_IOR, Queen_W_specular_anisotropy, Queen_W_specular_rotation, Queen_W_transmission, Queen_W_transmission_color, Queen_W_transmission_depth, Queen_W_transmission_scatter, Queen_W_transmission_scatter_anisotropy, Queen_W_transmission_dispersion, Queen_W_transmission_extra_roughness, sss1_out, diffuse1_out_cm_out, diffuse1_out_cm_out, Queen_W_subsurface_scale, Queen_W_subsurface_anisotropy, Queen_W_sheen, Queen_W_sheen_color, Queen_W_sheen_roughness, Queen_W_coat, Queen_W_coat_color, Queen_W_coat_roughness, Queen_W_coat_anisotropy, Queen_W_coat_rotation, Queen_W_coat_IOR, geomprop_Nworld_out, Queen_W_coat_affect_color, Queen_W_coat_affect_roughness, Queen_W_thin_film_thickness, Queen_W_thin_film_IOR, Queen_W_emission, Queen_W_emission_color, Queen_W_opacity, Queen_W_thin_walled, mtlxnormalmap3_out, geomprop_Tworld_out, Queen_W_out);

...
void main()
{
    ...
    mx_image_color3(diffuse5_file, diffuse5_layer, diffuse5_default, geomprop_UV0_out, diffuse5_uaddressmode, diffuse5_vaddressmode, diffuse5_filtertype, diffuse5_framerange, diffuse5_frameoffset, diffuse5_frameendaction, diffuse5_uv_scale, diffuse5_uv_offset, diffuse5_out);
    float roughness5_out = 0.0;
    mx_image_float(roughness5_file, roughness5_layer, roughness5_default, geomprop_UV0_out, roughness5_uaddressmode, roughness5_vaddressmode, roughness5_filtertype, roughness5_framerange, roughness5_frameoffset, roughness5_frameendaction, roughness5_uv_scale, roughness5_uv_offset, roughness5_out);
    vec3 normal5_out = vec3(0.0);
    mx_image_vector3(normal5_file, normal5_layer, normal5_default, geomprop_UV0_out, normal5_uaddressmode, normal5_vaddressmode, normal5_filtertype, normal5_framerange, normal5_frameoffset, normal5_frameendaction, normal5_uv_scale, normal5_uv_offset, normal5_out);
    vec3 diffuse5_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse5_out, diffuse5_out_cm_out);
    vec3 mtlxnormalmap7_out = vec3(0.0);
    mx_normalmap(normal5_out, mtlxnormalmap7_space, mtlxnormalmap7_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap7_out);
    surfaceshader Knight_W_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Knight_W_base, diffuse5_out_cm_out, Knight_W_diffuse_roughness, Knight_W_metalness, Knight_W_specular, Knight_W_specular_color, roughness5_out, Knight_W_specular_IOR, Knight_W_specular_anisotropy, Knight_W_specular_rotation, Knight_W_transmission, Knight_W_transmission_color, Knight_W_transmission_depth, Knight_W_transmission_scatter, Knight_W_transmission_scatter_anisotropy, Knight_W_transmission_dispersion, Knight_W_transmission_extra_roughness, Knight_W_subsurface, diffuse5_out_cm_out, diffuse5_out_cm_out, Knight_W_subsurface_scale, Knight_W_subsurface_anisotropy, Knight_W_sheen, Knight_W_sheen_color, Knight_W_sheen_roughness, Knight_W_coat, Knight_W_coat_color, Knight_W_coat_roughness, Knight_W_coat_anisotropy, Knight_W_coat_rotation, Knight_W_coat_IOR, geomprop_Nworld_out, Knight_W_coat_affect_color, Knight_W_coat_affect_roughness, Knight_W_thin_film_thickness, Knight_W_thin_film_IOR, Knight_W_emission, Knight_W_emission_color, Knight_W_opacity, Knight_W_thin_walled, mtlxnormalmap7_out, geomprop_Tworld_out, Knight_W_out);

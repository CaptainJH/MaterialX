...
void main()
{
    ...
    mx_image_color3(diffuse6_file, diffuse6_layer, diffuse6_default, geomprop_UV0_out, diffuse6_uaddressmode, diffuse6_vaddressmode, diffuse6_filtertype, diffuse6_framerange, diffuse6_frameoffset, diffuse6_frameendaction, diffuse6_uv_scale, diffuse6_uv_offset, diffuse6_out);
    float metallic6_out = 0.0;
    mx_image_float(metallic6_file, metallic6_layer, metallic6_default, geomprop_UV0_out, metallic6_uaddressmode, metallic6_vaddressmode, metallic6_filtertype, metallic6_framerange, metallic6_frameoffset, metallic6_frameendaction, metallic6_uv_scale, metallic6_uv_offset, metallic6_out);
    float roughness6_out = 0.0;
    mx_image_float(roughness6_file, roughness6_layer, roughness6_default, geomprop_UV0_out, roughness6_uaddressmode, roughness6_vaddressmode, roughness6_filtertype, roughness6_framerange, roughness6_frameoffset, roughness6_frameendaction, roughness6_uv_scale, roughness6_uv_offset, roughness6_out);
    vec3 normal6_out = vec3(0.0);
    mx_image_vector3(normal6_file, normal6_layer, normal6_default, geomprop_UV0_out, normal6_uaddressmode, normal6_vaddressmode, normal6_filtertype, normal6_framerange, normal6_frameoffset, normal6_frameendaction, normal6_uv_scale, normal6_uv_offset, normal6_out);
    vec3 diffuse6_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse6_out, diffuse6_out_cm_out);
    vec3 mtlxnormalmap8_out = vec3(0.0);
    mx_normalmap(normal6_out, mtlxnormalmap8_space, mtlxnormalmap8_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap8_out);
    surfaceshader Castle_B_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Castle_B_base, diffuse6_out_cm_out, Castle_B_diffuse_roughness, metallic6_out, Castle_B_specular, Castle_B_specular_color, roughness6_out, Castle_B_specular_IOR, Castle_B_specular_anisotropy, Castle_B_specular_rotation, Castle_B_transmission, Castle_B_transmission_color, Castle_B_transmission_depth, Castle_B_transmission_scatter, Castle_B_transmission_scatter_anisotropy, Castle_B_transmission_dispersion, Castle_B_transmission_extra_roughness, Castle_B_subsurface, diffuse6_out_cm_out, diffuse6_out_cm_out, Castle_B_subsurface_scale, Castle_B_subsurface_anisotropy, Castle_B_sheen, Castle_B_sheen_color, Castle_B_sheen_roughness, Castle_B_coat, Castle_B_coat_color, Castle_B_coat_roughness, Castle_B_coat_anisotropy, Castle_B_coat_rotation, Castle_B_coat_IOR, geomprop_Nworld_out, Castle_B_coat_affect_color, Castle_B_coat_affect_roughness, Castle_B_thin_film_thickness, Castle_B_thin_film_IOR, Castle_B_emission, Castle_B_emission_color, Castle_B_opacity, Castle_B_thin_walled, mtlxnormalmap8_out, geomprop_Tworld_out, Castle_B_out);

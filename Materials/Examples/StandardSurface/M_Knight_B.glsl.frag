...
void main()
{
    ...
    mx_image_color3(diffuse4_file, diffuse4_layer, diffuse4_default, geomprop_UV0_out, diffuse4_uaddressmode, diffuse4_vaddressmode, diffuse4_filtertype, diffuse4_framerange, diffuse4_frameoffset, diffuse4_frameendaction, diffuse4_uv_scale, diffuse4_uv_offset, diffuse4_out);
    float roughness4_out = 0.0;
    mx_image_float(roughness4_file, roughness4_layer, roughness4_default, geomprop_UV0_out, roughness4_uaddressmode, roughness4_vaddressmode, roughness4_filtertype, roughness4_framerange, roughness4_frameoffset, roughness4_frameendaction, roughness4_uv_scale, roughness4_uv_offset, roughness4_out);
    vec3 normal4_out = vec3(0.0);
    mx_image_vector3(normal4_file, normal4_layer, normal4_default, geomprop_UV0_out, normal4_uaddressmode, normal4_vaddressmode, normal4_filtertype, normal4_framerange, normal4_frameoffset, normal4_frameendaction, normal4_uv_scale, normal4_uv_offset, normal4_out);
    vec3 diffuse4_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse4_out, diffuse4_out_cm_out);
    vec3 mtlxnormalmap6_out = vec3(0.0);
    mx_normalmap(normal4_out, mtlxnormalmap6_space, mtlxnormalmap6_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap6_out);
    surfaceshader Knight_B_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Knight_B_base, diffuse4_out_cm_out, Knight_B_diffuse_roughness, Knight_B_metalness, Knight_B_specular, Knight_B_specular_color, roughness4_out, Knight_B_specular_IOR, Knight_B_specular_anisotropy, Knight_B_specular_rotation, Knight_B_transmission, Knight_B_transmission_color, Knight_B_transmission_depth, Knight_B_transmission_scatter, Knight_B_transmission_scatter_anisotropy, Knight_B_transmission_dispersion, Knight_B_transmission_extra_roughness, Knight_B_subsurface, diffuse4_out_cm_out, diffuse4_out_cm_out, Knight_B_subsurface_scale, Knight_B_subsurface_anisotropy, Knight_B_sheen, Knight_B_sheen_color, Knight_B_sheen_roughness, Knight_B_coat, Knight_B_coat_color, Knight_B_coat_roughness, Knight_B_coat_anisotropy, Knight_B_coat_rotation, Knight_B_coat_IOR, geomprop_Nworld_out, Knight_B_coat_affect_color, Knight_B_coat_affect_roughness, Knight_B_thin_film_thickness, Knight_B_thin_film_IOR, Knight_B_emission, Knight_B_emission_color, Knight_B_opacity, Knight_B_thin_walled, mtlxnormalmap6_out, geomprop_Tworld_out, Knight_B_out);

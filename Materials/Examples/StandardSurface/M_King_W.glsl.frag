...
void main()
{
    ...
    mx_image_color3(mtlximage7_file, mtlximage7_layer, mtlximage7_default, geomprop_UV0_out, mtlximage7_uaddressmode, mtlximage7_vaddressmode, mtlximage7_filtertype, mtlximage7_framerange, mtlximage7_frameoffset, mtlximage7_frameendaction, mtlximage7_uv_scale, mtlximage7_uv_offset, mtlximage7_out);
    float mtlximage10_out = 0.0;
    mx_image_float(mtlximage10_file, mtlximage10_layer, mtlximage10_default, geomprop_UV0_out, mtlximage10_uaddressmode, mtlximage10_vaddressmode, mtlximage10_filtertype, mtlximage10_framerange, mtlximage10_frameoffset, mtlximage10_frameendaction, mtlximage10_uv_scale, mtlximage10_uv_offset, mtlximage10_out);
    float mtlximage11_out = 0.0;
    mx_image_float(mtlximage11_file, mtlximage11_layer, mtlximage11_default, geomprop_UV0_out, mtlximage11_uaddressmode, mtlximage11_vaddressmode, mtlximage11_filtertype, mtlximage11_framerange, mtlximage11_frameoffset, mtlximage11_frameendaction, mtlximage11_uv_scale, mtlximage11_uv_offset, mtlximage11_out);
    float mtlximage8_out = 0.0;
    mx_image_float(mtlximage8_file, mtlximage8_layer, mtlximage8_default, geomprop_UV0_out, mtlximage8_uaddressmode, mtlximage8_vaddressmode, mtlximage8_filtertype, mtlximage8_framerange, mtlximage8_frameoffset, mtlximage8_frameendaction, mtlximage8_uv_scale, mtlximage8_uv_offset, mtlximage8_out);
    vec3 mtlximage9_out = vec3(0.0);
    mx_image_vector3(mtlximage9_file, mtlximage9_layer, mtlximage9_default, geomprop_UV0_out, mtlximage9_uaddressmode, mtlximage9_vaddressmode, mtlximage9_filtertype, mtlximage9_framerange, mtlximage9_frameoffset, mtlximage9_frameendaction, mtlximage9_uv_scale, mtlximage9_uv_offset, mtlximage9_out);
    vec3 mtlximage7_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(mtlximage7_out, mtlximage7_out_cm_out);
    vec3 mtlxnormalmap11_out = vec3(0.0);
    mx_normalmap(mtlximage9_out, mtlxnormalmap11_space, mtlxnormalmap11_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap11_out);
    surfaceshader King_W_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(King_W_base, mtlximage7_out_cm_out, King_W_diffuse_roughness, mtlximage10_out, King_W_specular, King_W_specular_color, mtlximage11_out, King_W_specular_IOR, King_W_specular_anisotropy, King_W_specular_rotation, King_W_transmission, King_W_transmission_color, King_W_transmission_depth, King_W_transmission_scatter, King_W_transmission_scatter_anisotropy, King_W_transmission_dispersion, King_W_transmission_extra_roughness, mtlximage8_out, mtlximage7_out_cm_out, mtlximage7_out_cm_out, King_W_subsurface_scale, King_W_subsurface_anisotropy, King_W_sheen, King_W_sheen_color, King_W_sheen_roughness, King_W_coat, King_W_coat_color, King_W_coat_roughness, King_W_coat_anisotropy, King_W_coat_rotation, King_W_coat_IOR, geomprop_Nworld_out, King_W_coat_affect_color, King_W_coat_affect_roughness, King_W_thin_film_thickness, King_W_thin_film_IOR, King_W_emission, King_W_emission_color, King_W_opacity, King_W_thin_walled, mtlxnormalmap11_out, geomprop_Tworld_out, King_W_out);

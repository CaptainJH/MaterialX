...
void main()
{
    ...
    mx_image_color3(diffuse_file, diffuse_layer, diffuse_default, geomprop_UV0_out, diffuse_uaddressmode, diffuse_vaddressmode, diffuse_filtertype, diffuse_framerange, diffuse_frameoffset, diffuse_frameendaction, diffuse_uv_scale, diffuse_uv_offset, diffuse_out);
    float metallic_out = 0.0;
    mx_image_float(metallic_file, metallic_layer, metallic_default, geomprop_UV0_out, metallic_uaddressmode, metallic_vaddressmode, metallic_filtertype, metallic_framerange, metallic_frameoffset, metallic_frameendaction, metallic_uv_scale, metallic_uv_offset, metallic_out);
    float roughness_out = 0.0;
    mx_image_float(roughness_file, roughness_layer, roughness_default, geomprop_UV0_out, roughness_uaddressmode, roughness_vaddressmode, roughness_filtertype, roughness_framerange, roughness_frameoffset, roughness_frameendaction, roughness_uv_scale, roughness_uv_offset, roughness_out);
    float sss_out = 0.0;
    mx_image_float(sss_file, sss_layer, sss_default, geomprop_UV0_out, sss_uaddressmode, sss_vaddressmode, sss_filtertype, sss_framerange, sss_frameoffset, sss_frameendaction, sss_uv_scale, sss_uv_offset, sss_out);
    vec3 normal_out = vec3(0.0);
    mx_image_vector3(normal_file, normal_layer, normal_default, geomprop_UV0_out, normal_uaddressmode, normal_vaddressmode, normal_filtertype, normal_framerange, normal_frameoffset, normal_frameendaction, normal_uv_scale, normal_uv_offset, normal_out);
    vec3 diffuse_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse_out, diffuse_out_cm_out);
    vec3 mtlxnormalmap2_out = vec3(0.0);
    mx_normalmap(normal_out, mtlxnormalmap2_space, mtlxnormalmap2_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap2_out);
    surfaceshader Queen_B_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Queen_B_base, diffuse_out_cm_out, Queen_B_diffuse_roughness, metallic_out, Queen_B_specular, Queen_B_specular_color, roughness_out, Queen_B_specular_IOR, Queen_B_specular_anisotropy, Queen_B_specular_rotation, Queen_B_transmission, Queen_B_transmission_color, Queen_B_transmission_depth, Queen_B_transmission_scatter, Queen_B_transmission_scatter_anisotropy, Queen_B_transmission_dispersion, Queen_B_transmission_extra_roughness, sss_out, diffuse_out_cm_out, diffuse_out_cm_out, Queen_B_subsurface_scale, Queen_B_subsurface_anisotropy, Queen_B_sheen, Queen_B_sheen_color, Queen_B_sheen_roughness, Queen_B_coat, Queen_B_coat_color, Queen_B_coat_roughness, Queen_B_coat_anisotropy, Queen_B_coat_rotation, Queen_B_coat_IOR, geomprop_Nworld_out, Queen_B_coat_affect_color, Queen_B_coat_affect_roughness, Queen_B_thin_film_thickness, Queen_B_thin_film_IOR, Queen_B_emission, Queen_B_emission_color, Queen_B_opacity, Queen_B_thin_walled, mtlxnormalmap2_out, geomprop_Tworld_out, Queen_B_out);

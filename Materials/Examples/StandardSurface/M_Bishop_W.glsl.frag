...
void main()
{
    ...
    mx_image_color3(diffuse3_file, diffuse3_layer, diffuse3_default, geomprop_UV0_out, diffuse3_uaddressmode, diffuse3_vaddressmode, diffuse3_filtertype, diffuse3_framerange, diffuse3_frameoffset, diffuse3_frameendaction, diffuse3_uv_scale, diffuse3_uv_offset, diffuse3_out);
    float metallic3_out = 0.0;
    mx_image_float(metallic3_file, metallic3_layer, metallic3_default, geomprop_UV0_out, metallic3_uaddressmode, metallic3_vaddressmode, metallic3_filtertype, metallic3_framerange, metallic3_frameoffset, metallic3_frameendaction, metallic3_uv_scale, metallic3_uv_offset, metallic3_out);
    float roughness3_out = 0.0;
    mx_image_float(roughness3_file, roughness3_layer, roughness3_default, geomprop_UV0_out, roughness3_uaddressmode, roughness3_vaddressmode, roughness3_filtertype, roughness3_framerange, roughness3_frameoffset, roughness3_frameendaction, roughness3_uv_scale, roughness3_uv_offset, roughness3_out);
    vec3 normal3_out = vec3(0.0);
    mx_image_vector3(normal3_file, normal3_layer, normal3_default, geomprop_UV0_out, normal3_uaddressmode, normal3_vaddressmode, normal3_filtertype, normal3_framerange, normal3_frameoffset, normal3_frameendaction, normal3_uv_scale, normal3_uv_offset, normal3_out);
    vec3 diffuse3_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse3_out, diffuse3_out_cm_out);
    vec3 mtlxnormalmap5_out = vec3(0.0);
    mx_normalmap(normal3_out, mtlxnormalmap5_space, mtlxnormalmap5_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap5_out);
    surfaceshader Bishop_W_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Bishop_W_base, diffuse3_out_cm_out, Bishop_W_diffuse_roughness, metallic3_out, Bishop_W_specular, Bishop_W_specular_color, roughness3_out, Bishop_W_specular_IOR, Bishop_W_specular_anisotropy, Bishop_W_specular_rotation, Bishop_W_transmission, Bishop_W_transmission_color, Bishop_W_transmission_depth, Bishop_W_transmission_scatter, Bishop_W_transmission_scatter_anisotropy, Bishop_W_transmission_dispersion, Bishop_W_transmission_extra_roughness, Bishop_W_subsurface, diffuse3_out_cm_out, diffuse3_out_cm_out, Bishop_W_subsurface_scale, Bishop_W_subsurface_anisotropy, Bishop_W_sheen, Bishop_W_sheen_color, Bishop_W_sheen_roughness, Bishop_W_coat, Bishop_W_coat_color, Bishop_W_coat_roughness, Bishop_W_coat_anisotropy, Bishop_W_coat_rotation, Bishop_W_coat_IOR, geomprop_Nworld_out, Bishop_W_coat_affect_color, Bishop_W_coat_affect_roughness, Bishop_W_thin_film_thickness, Bishop_W_thin_film_IOR, Bishop_W_emission, Bishop_W_emission_color, Bishop_W_opacity, Bishop_W_thin_walled, mtlxnormalmap5_out, geomprop_Tworld_out, Bishop_W_out);

...
void main()
{
    ...
    mx_image_color3(mtlximage13_file, mtlximage13_layer, mtlximage13_default, geomprop_UV0_out, mtlximage13_uaddressmode, mtlximage13_vaddressmode, mtlximage13_filtertype, mtlximage13_framerange, mtlximage13_frameoffset, mtlximage13_frameendaction, mtlximage13_uv_scale, mtlximage13_uv_offset, mtlximage13_out);
    float mtlximage16_out = 0.0;
    mx_image_float(mtlximage16_file, mtlximage16_layer, mtlximage16_default, geomprop_UV0_out, mtlximage16_uaddressmode, mtlximage16_vaddressmode, mtlximage16_filtertype, mtlximage16_framerange, mtlximage16_frameoffset, mtlximage16_frameendaction, mtlximage16_uv_scale, mtlximage16_uv_offset, mtlximage16_out);
    float mtlximage17_out = 0.0;
    mx_image_float(mtlximage17_file, mtlximage17_layer, mtlximage17_default, geomprop_UV0_out, mtlximage17_uaddressmode, mtlximage17_vaddressmode, mtlximage17_filtertype, mtlximage17_framerange, mtlximage17_frameoffset, mtlximage17_frameendaction, mtlximage17_uv_scale, mtlximage17_uv_offset, mtlximage17_out);
    vec3 mtlximage15_out = vec3(0.0);
    mx_image_vector3(mtlximage15_file, mtlximage15_layer, mtlximage15_default, geomprop_UV0_out, mtlximage15_uaddressmode, mtlximage15_vaddressmode, mtlximage15_filtertype, mtlximage15_framerange, mtlximage15_frameoffset, mtlximage15_frameendaction, mtlximage15_uv_scale, mtlximage15_uv_offset, mtlximage15_out);
    vec3 mtlximage13_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(mtlximage13_out, mtlximage13_out_cm_out);
    vec3 mtlxnormalmap12_out = vec3(0.0);
    mx_normalmap(mtlximage15_out, mtlxnormalmap12_space, mtlxnormalmap12_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap12_out);
    surfaceshader Chessboard_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Chessboard_base, mtlximage13_out_cm_out, Chessboard_diffuse_roughness, mtlximage16_out, Chessboard_specular, Chessboard_specular_color, mtlximage17_out, Chessboard_specular_IOR, Chessboard_specular_anisotropy, Chessboard_specular_rotation, Chessboard_transmission, Chessboard_transmission_color, Chessboard_transmission_depth, Chessboard_transmission_scatter, Chessboard_transmission_scatter_anisotropy, Chessboard_transmission_dispersion, Chessboard_transmission_extra_roughness, Chessboard_subsurface, mtlximage13_out_cm_out, mtlximage13_out_cm_out, Chessboard_subsurface_scale, Chessboard_subsurface_anisotropy, Chessboard_sheen, Chessboard_sheen_color, Chessboard_sheen_roughness, Chessboard_coat, Chessboard_coat_color, Chessboard_coat_roughness, Chessboard_coat_anisotropy, Chessboard_coat_rotation, Chessboard_coat_IOR, geomprop_Nworld_out, Chessboard_coat_affect_color, Chessboard_coat_affect_roughness, Chessboard_thin_film_thickness, Chessboard_thin_film_IOR, Chessboard_emission, Chessboard_emission_color, Chessboard_opacity, Chessboard_thin_walled, mtlxnormalmap12_out, geomprop_Tworld_out, Chessboard_out);

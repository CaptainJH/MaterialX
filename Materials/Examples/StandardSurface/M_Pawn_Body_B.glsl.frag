...
void main()
{
    ...
    mx_image_color3(diffuse9_file, diffuse9_layer, diffuse9_default, geomprop_UV0_out, diffuse9_uaddressmode, diffuse9_vaddressmode, diffuse9_filtertype, diffuse9_framerange, diffuse9_frameoffset, diffuse9_frameendaction, diffuse9_uv_scale, diffuse9_uv_offset, diffuse9_out);
    float metallic9_out = 0.0;
    mx_image_float(metallic9_file, metallic9_layer, metallic9_default, geomprop_UV0_out, metallic9_uaddressmode, metallic9_vaddressmode, metallic9_filtertype, metallic9_framerange, metallic9_frameoffset, metallic9_frameendaction, metallic9_uv_scale, metallic9_uv_offset, metallic9_out);
    float roughness9_out = 0.0;
    mx_image_float(roughness9_file, roughness9_layer, roughness9_default, geomprop_UV0_out, roughness9_uaddressmode, roughness9_vaddressmode, roughness9_filtertype, roughness9_framerange, roughness9_frameoffset, roughness9_frameendaction, roughness9_uv_scale, roughness9_uv_offset, roughness9_out);
    vec3 normal9_out = vec3(0.0);
    mx_image_vector3(normal9_file, normal9_layer, normal9_default, geomprop_UV0_out, normal9_uaddressmode, normal9_vaddressmode, normal9_filtertype, normal9_framerange, normal9_frameoffset, normal9_frameendaction, normal9_uv_scale, normal9_uv_offset, normal9_out);
    vec3 diffuse9_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse9_out, diffuse9_out_cm_out);
    vec3 mtlxnormalmap13_out = vec3(0.0);
    mx_normalmap(normal9_out, mtlxnormalmap13_space, mtlxnormalmap13_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap13_out);
    surfaceshader Pawn_Body_B_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Pawn_Body_B_base, diffuse9_out_cm_out, Pawn_Body_B_diffuse_roughness, metallic9_out, Pawn_Body_B_specular, Pawn_Body_B_specular_color, roughness9_out, Pawn_Body_B_specular_IOR, Pawn_Body_B_specular_anisotropy, Pawn_Body_B_specular_rotation, Pawn_Body_B_transmission, Pawn_Body_B_transmission_color, Pawn_Body_B_transmission_depth, Pawn_Body_B_transmission_scatter, Pawn_Body_B_transmission_scatter_anisotropy, Pawn_Body_B_transmission_dispersion, Pawn_Body_B_transmission_extra_roughness, Pawn_Body_B_subsurface, diffuse9_out_cm_out, diffuse9_out_cm_out, Pawn_Body_B_subsurface_scale, Pawn_Body_B_subsurface_anisotropy, Pawn_Body_B_sheen, Pawn_Body_B_sheen_color, Pawn_Body_B_sheen_roughness, Pawn_Body_B_coat, Pawn_Body_B_coat_color, Pawn_Body_B_coat_roughness, Pawn_Body_B_coat_anisotropy, Pawn_Body_B_coat_rotation, Pawn_Body_B_coat_IOR, geomprop_Nworld_out, Pawn_Body_B_coat_affect_color, Pawn_Body_B_coat_affect_roughness, Pawn_Body_B_thin_film_thickness, Pawn_Body_B_thin_film_IOR, Pawn_Body_B_emission, Pawn_Body_B_emission_color, Pawn_Body_B_opacity, Pawn_Body_B_thin_walled, mtlxnormalmap13_out, geomprop_Tworld_out, Pawn_Body_B_out);

...
void main()
{
    ...
    mx_image_color3(mtlximage1_file, mtlximage1_layer, mtlximage1_default, geomprop_UV0_out, mtlximage1_uaddressmode, mtlximage1_vaddressmode, mtlximage1_filtertype, mtlximage1_framerange, mtlximage1_frameoffset, mtlximage1_frameendaction, mtlximage1_uv_scale, mtlximage1_uv_offset, mtlximage1_out);
    float mtlximage2_out = 0.0;
    mx_image_float(mtlximage2_file, mtlximage2_layer, mtlximage2_default, geomprop_UV0_out, mtlximage2_uaddressmode, mtlximage2_vaddressmode, mtlximage2_filtertype, mtlximage2_framerange, mtlximage2_frameoffset, mtlximage2_frameendaction, mtlximage2_uv_scale, mtlximage2_uv_offset, mtlximage2_out);
    float mtlximage4_out = 0.0;
    mx_image_float(mtlximage4_file, mtlximage4_layer, mtlximage4_default, geomprop_UV0_out, mtlximage4_uaddressmode, mtlximage4_vaddressmode, mtlximage4_filtertype, mtlximage4_framerange, mtlximage4_frameoffset, mtlximage4_frameendaction, mtlximage4_uv_scale, mtlximage4_uv_offset, mtlximage4_out);
    float mtlximage3_out = 0.0;
    mx_image_float(mtlximage3_file, mtlximage3_layer, mtlximage3_default, geomprop_UV0_out, mtlximage3_uaddressmode, mtlximage3_vaddressmode, mtlximage3_filtertype, mtlximage3_framerange, mtlximage3_frameoffset, mtlximage3_frameendaction, mtlximage3_uv_scale, mtlximage3_uv_offset, mtlximage3_out);
    vec3 mtlximage6_out = vec3(0.0);
    mx_image_vector3(mtlximage6_file, mtlximage6_layer, mtlximage6_default, geomprop_UV0_out, mtlximage6_uaddressmode, mtlximage6_vaddressmode, mtlximage6_filtertype, mtlximage6_framerange, mtlximage6_frameoffset, mtlximage6_frameendaction, mtlximage6_uv_scale, mtlximage6_uv_offset, mtlximage6_out);
    vec3 mtlximage1_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(mtlximage1_out, mtlximage1_out_cm_out);
    vec3 mtlxnormalmap1_out = vec3(0.0);
    mx_normalmap(mtlximage6_out, mtlxnormalmap1_space, mtlxnormalmap1_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap1_out);
    surfaceshader King_B_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(King_B_base, mtlximage1_out_cm_out, King_B_diffuse_roughness, mtlximage2_out, King_B_specular, King_B_specular_color, mtlximage4_out, King_B_specular_IOR, King_B_specular_anisotropy, King_B_specular_rotation, King_B_transmission, King_B_transmission_color, King_B_transmission_depth, King_B_transmission_scatter, King_B_transmission_scatter_anisotropy, King_B_transmission_dispersion, King_B_transmission_extra_roughness, mtlximage3_out, mtlximage1_out_cm_out, mtlximage1_out_cm_out, King_B_subsurface_scale, King_B_subsurface_anisotropy, King_B_sheen, King_B_sheen_color, King_B_sheen_roughness, King_B_coat, King_B_coat_color, King_B_coat_roughness, King_B_coat_anisotropy, King_B_coat_rotation, King_B_coat_IOR, geomprop_Nworld_out, King_B_coat_affect_color, King_B_coat_affect_roughness, King_B_thin_film_thickness, King_B_thin_film_IOR, King_B_emission, King_B_emission_color, King_B_opacity, King_B_thin_walled, mtlxnormalmap1_out, geomprop_Tworld_out, King_B_out);

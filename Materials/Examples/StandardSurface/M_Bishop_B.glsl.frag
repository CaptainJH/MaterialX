...
void main()
{
    ...
    mx_image_color3(diffuse2_file, diffuse2_layer, diffuse2_default, geomprop_UV0_out, diffuse2_uaddressmode, diffuse2_vaddressmode, diffuse2_filtertype, diffuse2_framerange, diffuse2_frameoffset, diffuse2_frameendaction, diffuse2_uv_scale, diffuse2_uv_offset, diffuse2_out);
    float metallic2_out = 0.0;
    mx_image_float(metallic2_file, metallic2_layer, metallic2_default, geomprop_UV0_out, metallic2_uaddressmode, metallic2_vaddressmode, metallic2_filtertype, metallic2_framerange, metallic2_frameoffset, metallic2_frameendaction, metallic2_uv_scale, metallic2_uv_offset, metallic2_out);
    float roughness2_out = 0.0;
    mx_image_float(roughness2_file, roughness2_layer, roughness2_default, geomprop_UV0_out, roughness2_uaddressmode, roughness2_vaddressmode, roughness2_filtertype, roughness2_framerange, roughness2_frameoffset, roughness2_frameendaction, roughness2_uv_scale, roughness2_uv_offset, roughness2_out);
    vec3 normal2_out = vec3(0.0);
    mx_image_vector3(normal2_file, normal2_layer, normal2_default, geomprop_UV0_out, normal2_uaddressmode, normal2_vaddressmode, normal2_filtertype, normal2_framerange, normal2_frameoffset, normal2_frameendaction, normal2_uv_scale, normal2_uv_offset, normal2_out);
    vec3 diffuse2_out_cm_out = vec3(0.0);
    mx_srgb_texture_to_lin_rec709_color3(diffuse2_out, diffuse2_out_cm_out);
    vec3 mtlxnormalmap4_out = vec3(0.0);
    mx_normalmap(normal2_out, mtlxnormalmap4_space, mtlxnormalmap4_scale, geomprop_Nworld_out, geomprop_Tworld_out, mtlxnormalmap4_out);
    surfaceshader Bishop_B_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(Bishop_B_base, diffuse2_out_cm_out, Bishop_B_diffuse_roughness, metallic2_out, Bishop_B_specular, Bishop_B_specular_color, roughness2_out, Bishop_B_specular_IOR, Bishop_B_specular_anisotropy, Bishop_B_specular_rotation, Bishop_B_transmission, Bishop_B_transmission_color, Bishop_B_transmission_depth, Bishop_B_transmission_scatter, Bishop_B_transmission_scatter_anisotropy, Bishop_B_transmission_dispersion, Bishop_B_transmission_extra_roughness, Bishop_B_subsurface, diffuse2_out_cm_out, diffuse2_out_cm_out, Bishop_B_subsurface_scale, Bishop_B_subsurface_anisotropy, Bishop_B_sheen, Bishop_B_sheen_color, Bishop_B_sheen_roughness, Bishop_B_coat, Bishop_B_coat_color, Bishop_B_coat_roughness, Bishop_B_coat_anisotropy, Bishop_B_coat_rotation, Bishop_B_coat_IOR, geomprop_Nworld_out, Bishop_B_coat_affect_color, Bishop_B_coat_affect_roughness, Bishop_B_thin_film_thickness, Bishop_B_thin_film_IOR, Bishop_B_emission, Bishop_B_emission_color, Bishop_B_opacity, Bishop_B_thin_walled, mtlxnormalmap4_out, geomprop_Tworld_out, Bishop_B_out);
